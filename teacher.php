...
<a class="navbar-brand" href="index.php">Mepco Online Attendance</a>
...
<div><strong>Section</strong> : <span
class="section">'.$section.'</span></div>
...
<div class="modal fade delete-warning" tabindex="-1" role="dialog" aria-
labelledby="delete-warning" aria-hidden="true">
...
<button class="btn btn-danger delete-class-code">Delete</button> <button
class="btn btn-primary" onclick="$('.delete-warning').modal('hide');">Cancel</button>
</div>
</div>
</div>
</div>
